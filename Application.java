...
public class Application {
    ...
    public void getEducationInfo(String userLogin){
        System.out.println("Now you study at " + controller1.getEducationInfo(userLogin));
    }

    public void getJobInfo(String userLogin) {
        System.out.println("Now you work as" + controller1.getJobInfo(userLogin));
    }
    ...
    public boolean findVacancies() { // vacancies
        while(true){
    ...
    public void getBusinessInfo(String userLogin){
        System.out.println("Now you are owner of " + controller1.getBusinessInfo(userLogin));
    }
